...
class SocketCustom {
  InternetAddress get ip => _socket.remoteAddress;
  ...
  Future<Database> _dbValues() async {
    try {
      ...
      return Database(_ipDatabase, _portDatabase, dbValues['database'],
          dbValues['username'], dbValues['password']);
    } on SocketException catch (e) {
      throw SocketException(
          '(CustomSocket)_dbValues: Connection lost with ${_socket.address}\n$e');
    } catch (e) {
      throw Exception(e);
    }
  }
  ...
  Future<Database> init() async {
    print('Connection from : ${ip.address}');
    try {
      ...
      throw SocketException(
          '(CustomSocket)init: Connection lost with ${_socket.address}\n$e');
    } on EncryptionException catch (e) {
      throw ClientException('(CustomSocket)init:\n$e');
    } catch (e) {
      throw Exception('(CustomSocket)init: Connection lost with host\n$e');
    }
  }
  ...
  Future<Database> setup() async {
    try {
      ...
      throw SocketException(
          '(CustomSocket)setup: Connection lost with ${_socket.address}\n$e');
    } on EncryptionException catch (e) {
      throw EncryptionException('(SocketCustom)setup:\n$e');
    } catch (e) {
      throw Exception('(CustomSocket)setup: Connection lost with host\n$e');
    }
  }
  ...
  Future<void> write(String plainText) async {
    try {
      ...
      throw SocketException('(CustomSocket)write\n$e');
    } catch (e) {
  ...
  Future<void> writeSym(String plainText) async {
    try {
      ...
      throw SocketException('(CustomSocket)writeSym:\n$e');
    } catch (e) {
  ...
  Future<void> synchronizeWrite() async {
    try {
      ...
      throw SocketException('(CustomSocket)synchronizeWrite:\n$e');
    } catch (e) {
  ...
  Future<String> read() async {
    try {
      ...
      throw SocketException('(CustomSocket)read\n$e');
    } on EncryptionException catch (e) {
      throw EncryptionException('(CustomSocket)read:\n$e');
    } catch (e) {
  ...
  Future<String> readAsym() async {
    try {
      return _asym.decrypt(await _queue.next);
    } on SocketException catch (e) {
      throw SocketException('(CustomSocket)readAsym\n$e');
    } on EncryptionException catch (e) {
      throw EncryptionException('(CustomSocket)readAsym:\n$e');
    } catch (e) {
      throw Exception('(CustomSocket)readAsym:\n$e');
    }
  }
  ...
  Future<String> readSym() async {
    try {
      ...
      throw SocketException('(CustomSocket)readSym:\n$e');
    } on EncryptionException catch (e) {
      throw EncryptionException('(CustomSocket)readSym:\n$e');
    } catch (e) {
  ...
  Future<void> synchronizeRead() async {
    try {
      ...
      throw SocketException('(CustomSocket)synchronizeRead:\n$e');
    } catch (e) {
